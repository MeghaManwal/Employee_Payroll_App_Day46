...
// (Day-46) UC-3 To create EmployeePayroll Object on Save
const save = () => {
    try {
...
//(Day-46) UC-4 To save Employee Payroll Object to Local Storage
...
//(Day-46) UC-5 To reset the form on Clicking reset
const resetForm = () => {
    setValue('#name', '');
